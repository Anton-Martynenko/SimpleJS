import {
    ...
    changeManAge,
    changeMothersAge,
    changeNumber, changeParentAge, changeParentDishTitle,
    changePeopleAge,
    makeHairstyle,
    moveUser,
...
test('deep copy 9', () => {
    ...
    let man6FullCopy = changeParentDishTitle(man6, "Jennifer", "meat");

    expect(man6FullCopy.mother.parents[1].favoriteDish.title).toBe("meat");
